...
const AuthLayout = ({ children }: AuthLayoutProps) => (
  <div className="container relative grid h-dvh flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0 mx-auto">
    <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
      <div className="absolute inset-0 bg-zinc-900">
        <div className="relative h-dvh w-full">
          <div className="from-color-2 to-color-5 absolute inset-0 bg-gradient-to-t opacity-50" />
          <Image className=" h-full object-contain bg-background" src={'/bg.png'} alt="bg" width={1280} height={768} />
        </div>
      </div>
